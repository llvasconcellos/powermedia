...
require("funcoes.php");
inicia_pagina();
monta_titulo_secao("Impressão de Etiquetas", "home.php");
...
<script language="javascript">
	if((screen.width != 1024) || (screen.height != 768)) alert('Para correta impressão das etiquetas a sua resolução de tela deve ser de 1024x768.');
...
<table width="100%">
	<tr>
		...
		<? inicia_quadro_branco('width="90%"', "Impressão de Etiquetas"); ?>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td>
						<table width="100%" cellpadding="4" cellspacing="4">
							<tr>
								<td class="label" width="35%">Etiquetas já Impressas:</td>
								<td><input type="text" name="qtd_impressa" maxlength="4" class="input_text"></td>
								<td class="label" width="30%">Multiplicador:</td>
								<td><input type="text" name="multiplicador" maxlength="4" class="input_text"></td>
							</tr>
						</table>
					</td>
					<td></td>
					<td>
						<select name="id_tipo_media" onChange="valida_form(); document.forms[0].target = '_self'; document.forms[0].action = 'form_etiquetas.php'; document.forms[0].submit();">
							<?php
				...
				<tr>
					<td>
						<table width="100%" cellpadding="4" cellspacing="4">
							<tr>
								<td class="label" width="40%">Largura da Etiqueta (pixels):</td>
								<td><input type="text" name="largura" value="<?=retorna_config("pixel_w_etiqueta")?>" maxlength="4" class="input_text"></td>
							</tr>
						</table>
					</td>
					<td></td>
					<td align="right">
						<table width="100%" cellpadding="4" cellspacing="4">
							<tr>
								<td class="label" width="40%">Altura da Etiqueta (pixels):</td>
								<td><input type="text" name="altura" value="<?=retorna_config("pixel_h_etiqueta")?>" maxlength="4" class="input_text"></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td>
						<table width="100%" cellpadding="4" cellspacing="4">
							<tr>
								<td class="label" width="55%">Tamanho da fonte da Etiqueta (pixels):</td>
								<td><input type="text" name="fonte" value="<?=retorna_config("tamanho_fonte_etiqueta")?>" maxlength="4" class="input_text"></td>
							</tr>
						</table>
					</td>
					<td></td>
					<td align="right">
						<table width="100%" cellpadding="4" cellspacing="4">
							<tr>
								<td class="label" width="45%">Limite de Caracteres na Etiqueta:</td>
								<td><input type="text" name="limite_caracteres" value="<?=retorna_config("limite_caracteres_etiqueta")?>" maxlength="4" class="input_text"></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td>
						<table width="100%" cellpadding="4" cellspacing="4">
							<tr>
								<td class="label" width="50%">Quantidade de Etiquetas por Linha:</td>
								<td><input type="text" name="etiquetas_linha" value="<?=retorna_config("etiquetas_linha")?>" maxlength="4" class="input_text"></td>
							</tr>
						</table>
					</td>
					<td></td>
					<td align="right">
						<table width="100%" cellpadding="4" cellspacing="4">
							<tr>
								<td class="label" width="50%">Quantidade de Linhas Por Página:</td>
								<td><input type="text" name="linhas_pagina_etiqueta" value="<?=retorna_config("linhas_pagina_etiqueta")?>" maxlength="4" class="input_text"></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td>
						<table width="100%" cellpadding="4" cellspacing="4">
							<tr>
								<td class="label" width="50%">Espaçamento entre etiquetas:</td>
								<td><input type="text" name="espacamento_etiquetas" value="<?=retorna_config("espacamento_etiquetas")?>" maxlength="4" class="input_text"></td>
							</tr>
						</table>
					</td>
					<td></td>
					<td align="right">
						<table width="100%" cellpadding="4" cellspacing="4">
							<tr>
								<td class="label" width="5%">Borda:</td>
								<td align="left"><input type="checkbox" name="borda"></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					...
					<td></td>
					<td align="right">
						<input type="button" value="Proximo >>>" class="botao_aqua" onClick="document.forms[0].action = 'gera_etiquetas.php'; valida_form();  document.forms[0].target='_blank'; document.forms[0].submit();">
					</td>
				</tr>
			</table>
			</form>
